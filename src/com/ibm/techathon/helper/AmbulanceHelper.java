	...
	public String getAmbulanceList(double latitude, double longitude) {
		...
		//	System.out.println("File Path" + filePath);
			...
			System.out.println("Root element of the doc is "
					+ ambDoc.getDocumentElement().getNodeName());
			...
			for (i = 0; i < totalAmbulances; i++) {
				...
				if (currNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					// -------xCol--
					NodeList xCoList = firstAmbulanceElement
					...
					// -------yCol--
					NodeList yCoList = firstAmbulanceElement
				...
				//	System.out.println(isAmbulanceValid);
					...
					if (isAmbulanceValid) {
						...
						NodeList nameList = firstAmbulanceElement
						...
						// -------ID--
						NodeList iDList = firstAmbulanceElement
						...
						// -------Address--
						NodeList addressList = firstAmbulanceElement
						...
						// -------Contact--
						NodeList contactList = firstAmbulanceElement
						...
						// -------Distance--
				/*		NodeList distanceList = firstAmbulanceElement
								.getElementsByTagName("distance");
						Element distanceElement = (Element) distanceList
								.item(0);
						NodeList textDistanceList = distanceElement
								.getChildNodes();
						distance = textDistanceList.item(0).getNodeValue()
								.trim();*/
						// -- end
